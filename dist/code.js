...
function getIndexFromAlignment(primary, counter, layoutMode) {
                ...
                if (node.type === 'GROUP') {
                    ...
                    if (figma.command === 'wh') {
                        ...
                        if ('cornerRadius' in operableNode) {
                            operableNode.cornerRadius = 8; // Cast to any for mixed type
                            modifiedCount++;
                        }
                    }
                        ...
                        if ('cornerRadius' in operableNode) {
                            operableNode.cornerRadius = 0; // Cast to any for mixed type
                            modifiedCount++;
                        }
                    }
                }
